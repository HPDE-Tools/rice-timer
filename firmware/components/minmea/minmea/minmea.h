 ...
 */
static inline int_least32_t minmea_rescale(struct minmea_float const* f, int_least32_t new_scale) {
 ...
 */
static inline float minmea_tofloat(struct minmea_float const* f) {
 ...
 * Returns NaN for "unknown" values.
 */
static inline float minmea_tocoord(struct minmea_float const* f) {
  if (f->scale == 0) return NAN;
