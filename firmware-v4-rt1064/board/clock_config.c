...
- {id: FLEXIO2_CLK_ROOT.outFreq, value: 80 MHz}
- {id: FLEXSPI2_CLK_ROOT.outFreq, value: 264 MHz}
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 2376/29 MHz}
...
- {id: CCM_ANALOG.PLL3_PFD1_DIV.scale, value: '14'}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetDiv(kCLOCK_Flexio2PreDiv, 2);
    ...
    /* Init Usb1 pfd1. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd1, 14);
    /* Init Usb1 pfd2. */
